...
public class WatchLecture extends AppCompatActivity {
    private ZoomSDKAuthenticationListener authListener = new ZoomSDKAuthenticationListener() {
        ...
        public void onZoomSDKLoginResult(long result) {
            if (result == ZoomAuthenticationError.ZOOM_AUTH_ERROR_SUCCESS) {
                ...
                startMeeting(WatchLecture.this);
            }
        }
    ...
    public void initializeSdk(Context context) {
        ...
        params.appKey = "BHVFVsdngFs2NmL2kqU9dAZEjHQfKpm01ZlQ"; // TODO: Retrieve your SDK key and enter it here
        params.appSecret = "o7ge0QkTAegNAXh4ct61uSwYSPgrSo95OWoZ"; // TODO: Retrieve your SDK secret and enter it here
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (numberInput != null && numberInput.getText() != null && passwordInput != null && passwordInput.getText() != null) {
                ...
                if (meetingNumber.trim().length() > 0 && password.trim().length() > 0) {
                    joinMeeting(WatchLecture.this, meetingNumber, password);
                }
            }
            dialog.dismiss();
        }
